...
%% Creating a subject-specific total brain mask.

%anat_targetdir: path to NIfTI anatomical data: anat_targetdir(i,1)
%grey: file output from the previous anat step, i.e. build_functionalmask_normalized: 'wgrey.nii'
%white: file output from the previous anat step, i.e. build_functionalmask_normalized: 'wwhite.nii'
%csf: file output from the previous anat step, i.e. build_functionalmask_normalized: 'wcsf.nii'
