function [] = build_functionalmask_normalized(func_targetdir, anat_targetdir, func_file, wc1c, wc2c, wc3c, sub_name)

%% Build individual masks based on a normalized individual T1.
...
%wc1c, wc2c, wc3c: file output from the previous anat step, i.e. normalize_anat: 'wc1c.*\.*', 'wc2c.*\.*', 'wc3c.*\.*'
