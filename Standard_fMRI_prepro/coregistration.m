function [] = coregistration(func_targetdir, anat_targetdir, func_file, anat_file, sub_name)
...
if do_coregister
        ...
        %Structure to function! - Ruth: function to structure
        
        matlabbatch{ibatch}.spm.spatial.coreg.estwrite.ref(1) = cellstr(spm_select('ExtFPList', func_targetdir, func_file, 1));
        ...
        matlabbatch{ibatch}.spm.spatial.coreg.estwrite.roptions.prefix = 'c'; %Roma: 'r'
