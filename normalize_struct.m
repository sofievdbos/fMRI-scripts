function [] = normalize_struct(anat_targetdir, anat_file, c, c1, c2, c3, c4, c5, voxel_size, interp, sub_name)

%% Running anatomical normalization.
...
%voxel_size: original voxel size of anatomical images; in this example :[1 1 1]
