...
%quality: default value as indicated in the SPM batch: 0.9 - Roma: 1
%interp1: interpolation; default value as indicated in the SPM batch: 2 - Roma: 2
%interp2: interpolation; default value as indicated in the SPM batch: 4 - Roma: 4
...
do_realign = 1;
    ...
    if do_realign
        ...
        matlabbatch{ibatch}.spm.spatial.realign.estwrite.eoptions.rtm = 0; %realign to first image  
