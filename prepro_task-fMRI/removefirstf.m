function [] = removefirstf(convert3D, removefirstf, convert4D, func_targetdir, file1, file2, name, sub_name)
...
%% REMARK: (1) adapt the number of to be removed scans (line 45 etc.): check whether you didn't remove to many (Display)!
%          (2) do not forget to change file 1 and 2 (correct prefix)
%%
...
for irun = 1:1 %1x functional data (verb generation task)
        ...
        if do_3Dto4D
            ...
            matlabbatch{ibatch}.spm.util.cat.name = [name];
