function [] = normalize_func(anat_targetdir, func_targetdir, anat_file, func_file, voxel_size, interp, sub_name)
...
%func_file: file output from the previous func step, i.e. realign: '^rof4D.*\.*'
%voxel_size: original voxel size of the functional images; in this example: [3 3 3] - Roma: [2 2 2]
%interp: interpolation; default value as indicated in the SPM batch: 4 - Roma: 4
...
if do_normalize
        ...
        matlabbatch{ibatch}.spm.spatial.normalise.write.subj.resample = cellstr(spm_select('ExtFPList', func_targetdir, func_file, Inf));;
